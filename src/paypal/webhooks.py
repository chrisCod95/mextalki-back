...
from src.paypal.api_client import get_subscription
...
PAYPAL_EVENT_TYPES = MappingProxyType({
    'BILLING.SUBSCRIPTION.ACTIVATED': process_subscription_activated,
    'BILLING.SUBSCRIPTION.CANCELLED': process_subscription_cancelled,
    'BILLING.SUBSCRIPTION.CREATED': process_subscription_created,
    'BILLING.SUBSCRIPTION.EXPIRED': process_subscription_expired,
    'BILLING.SUBSCRIPTION.PAYMENT.FAILED': process_subscription_payment_failed,
    'BILLING.SUBSCRIPTION.RE-ACTIVATED': process_subscription_re_activated,
    'BILLING.SUBSCRIPTION.RENEWED': process_subscription_renewed,
    'BILLING.SUBSCRIPTION.SUSPENDED': process_subscription_suspended,
    'BILLING.SUBSCRIPTION.UPDATED': process_subscription_updated,
    'PAYMENT.SALE.COMPLETED': payment_sale_completed,
})
